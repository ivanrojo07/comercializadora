@extends('layouts.infocliente')
	@section('cliente')
					<ul role="tablist" class="nav nav-tabs nav-pills nav-justified">
						...
						<li class="ui-tabs-tab ui-corner-top ui-state-default ui-tab"><a href="{{ route('clientes.direccionfiscal.index',['cliente'=>$personal]) }}">Dirección Fiscal:</a></li>
					...
					<div class="panel-default">
						...
						<div class="panel-body">
							...
							<a class="btn btn-info" href="{{ route('clientes.contacto.edit',['cliente'=>$personal,'contacto'=>$contacto]) }}">Editar</a>
						</div>
					</div>
  				</div>
			</form>
