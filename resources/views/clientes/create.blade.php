			...
			<form role="form" id="form-cliente" method="POST" action="{{ route('clientes.store') }}" name="form">
				...
				<div role="application" class="panel panel-group" >
							...
							<div class="col-md-12 offset-md-2 mt-3">
			  					...
			  					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
			  						<label class="control-label" for="alias">
			  								<i class="fa fa-asterisk" aria-hidden="true"></i>
			  						 Alias:</label>
			  						<input type="text" class="form-control" id="alias" name="alias" autofocus
			  						required>
			  					</div>
			  					<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
			  						<label class="control-label" for="rfc">
			  					<i class="fa fa-asterisk" aria-hidden="true"></i> RFC:</label>
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="">Dirección Fisìca:</a></li>
					...
					<div class="panel panel-default">
						<div class="panel-heading">Dirección Fisìca: &nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-asterisk" aria-hidden="true"></i>Campos Requeridos</div>
						<div class="panel-body">
