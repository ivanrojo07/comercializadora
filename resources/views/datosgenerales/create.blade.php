					 	...
					 	<div class="panel-body">
					 		<div class="col-md-12 offset-md-2 mt-3">
					 			...
					 			<label class="control-label" for="nombre">Giro:</label>
			    					<select type="select" name="giro" class="form-control" id="giro">
			    						<option>Uno</option>
			    						<option>Dos</option>
			    					</select>
					 			</div>
					 			...
					 			<label class="control-label" for="nombre">Tamaño de la empresa:</label>
			    					<select type="select" name="giro" class="form-control" id="tamano">
					 			...
					 			<label class="control-label" for="formacontacto">Forma de contacto:</label>
			    					<select type="select" name="giro" class="form-control" id="formacontacto">
					 		...
					 		<div class="col-md-12 offset-md-2 mt-3">
					 			...
					 			<div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
					 				<label class="control-label" for="fechacontacto">Sitio web:</label>
